...
public class MainActivity extends BaseActivity<ActivityMainBinding, MainViewModel> implements MainNavigator, HasSupportFragmentInjector {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        setUpQuizInfo();
        QuizInfo.context=this;
        current_question_no.setText(String.valueOf(QuizInfo.question_no));
        //
        if(QuizInfo.quiz_state.isEmpty()) QuizInfo.loadQuizInitialState();
        QuizInfo.resolveQuestionState(false);
        ...
        mCardsContainerView.addItemRemoveListener(count -> {
            if (count == 0) {
                ...
                new Handler(getMainLooper()).postDelayed(() -> {
                    ...
                    QuizInfo.question_no=1;
                    QuizInfo.option_selected=false;
                    current_question_no.setText(String.valueOf(QuizInfo.question_no));
                    Toast.makeText(MainActivity.this, "Quiz finished", Toast.LENGTH_SHORT).show();
                    //
                    QuizInfo.quiz_state.clear();
                    QuizInfo.current_question_state=-1;
                    QuizInfo.loadQuizInitialState();
                    QuizInfo.resolveQuestionState(false);
                }, 800);
            } else {
    ...
    private void setUpQuizInfo(){
        current_question_no=findViewById(R.id.current_question_no);
    }

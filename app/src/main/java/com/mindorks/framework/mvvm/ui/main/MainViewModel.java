...
public class MainViewModel extends BaseViewModel<MainNavigator> {
    ...
    public void removeQuestionCard() {
        ...
        QuizInfo.question_no++;
        QuizInfo.option_selected=false;
        TextView current_question =((Activity) QuizInfo.context).findViewById(R.id.current_question_no);
        current_question.setText(String.valueOf(QuizInfo.question_no));
        //
